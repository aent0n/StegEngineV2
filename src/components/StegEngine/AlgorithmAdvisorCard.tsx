// Résumé du fichier : Composant qui fournit un conseiller d'algorithme de stéganographie alimenté par l'IA.
// Les utilisateurs saisissent le type de fichier et la description du message pour obtenir une suggestion.
"use client";
...
const advisorSchema = z.object({
  fileType: z.enum(['image', 'audio', 'text', 'pdf'], { 
