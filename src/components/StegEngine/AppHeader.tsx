// Résumé du fichier : Définit le composant global d'en-tête pour l'application Steg'Engine.
// Inclut le logo de l'application, le nom et un bouton de basculement de thème.
"use client";
