// Résumé du fichier : Composant pour les outils de stéganographie textuelle.
// Gère la saisie du texte porteur, du message à intégrer, affiche le texte stéganographié,
// et offre des options pour la génération de texte porteur par IA.
"use client";
