// Résumé du fichier : Composant de page pour l'outil de Stéganographie Audio.
// Permet aux utilisateurs d'intégrer et d'extraire des messages dans des fichiers audio en utilisant divers algorithmes.
"use client";
